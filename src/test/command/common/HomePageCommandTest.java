...
public class HomePageCommandTest {
    ...
    public void execute_Request_CorrectResponse(String userId, User user, int[] times, Booking booking, Response expected) throws ServiceException, InvalidInputException {
        ...
        verify(userService, times(times[5])).getVisitors();
    ...
    public void execute_Request_ServiceException(String userId, Booking booking, Response expected) throws ServiceException, InvalidInputException {
        when(session.getAttribute(Constants.Parameter.USER_ID)).thenReturn(userId);
    ...
    public void execute_Request_InvalidInputException(String userId, Booking booking, Response expected) throws ServiceException, InvalidInputException {
        when(session.getAttribute(Constants.Parameter.USER_ID)).thenReturn(userId);
